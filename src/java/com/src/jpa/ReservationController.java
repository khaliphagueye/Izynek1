...
import com.src.jpa.util.JsfUtil;
import com.src.jpa.util.PaginationHelper;
import com.src.session.ReservationFacade;
...
public class ReservationController implements Serializable {
    ...
    @EJB
    private com.src.session.ReservationFacade ejbFacade;
